...
body = f'''<section class="hero" style="border-top:none; padding-bottom:0;">
  ...
  <section>
    ...
    <div class="product-grid">
      {amz_item("Step 1 &middot; Every Card", "Penny Sleeves", "~$5 / 100", "The first layer for literally every card. Soft polypropylene, acid-free, no PVC. Buy in bulk &mdash; you will always use more than you think.", "card penny sleeves soft acid free")}
      {amz_item("Step 2 &middot; Rigid Protection", "Top Loaders (3x4)", "~$8 / 25", "Rigid PVC holders for sleeved cards. The workhorse for shipping, storing, and showing singles. Standard 35pt for base; thicker (55&ndash;130pt) for jersey/patch cards.", "card top loaders 3x4 35pt")}
      {amz_item("For Grading &middot; PSA", "Card Savers I", "~$10 / 50", "Semi-rigid holders &mdash; <strong>this is what PSA asks you to submit cards in</strong>, not top loaders. Flexible enough to insert/remove safely. Essential if you're grading.", "card savers 1 semi rigid psa")}
      {amz_item("Keepers &middot; Display", "Magnetic One-Touch", "~$15 / 5", "Premium magnetic-close acrylic cases for your best raw cards and hits. UV-protective, display-grade. Match the point size to the card (35pt base, 75&ndash;180pt for thick).", "magnetic one touch card holder 35pt uv")}
      {amz_item("Submission &middot; Safety", "Semi-Rigid + Team Bags", "~$6 / 100", "Resealable sleeves to bag a sleeved-and-saved card before shipping or submitting &mdash; keeps the Card Saver closed and dust out. Cheap insurance.", "card team bags resealable 4x6")}
      {amz_item("Storage &middot; Bulk", "Cardboard Storage Boxes", "~$12 / 3-pack", "500ct / 800ct boxes for raw bulk and sets. Label by sport/year. Keep them somewhere cool and dry &mdash; humidity warps cardboard and chrome.", "baseball card storage boxes 500 count")}
    </div>
  </section>
