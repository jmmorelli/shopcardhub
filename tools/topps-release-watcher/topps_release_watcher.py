...
def scaffold_draft(rel, shell):
  ...
  <section>
    ...
    <div class="avoid-list" style="border-left-color:var(--accent);">
      ...
      {pb.avoid_item("<strong>Where to buy</strong> &mdash; eBay singles + sealed (EPN) / COMC. No topps.com or Fanatics buy-links (both affiliate lanes retired Aug 2026).").replace("&#10007;","&#9633;")}
