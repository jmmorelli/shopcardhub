#!/usr/bin/env python3
"""
build_soccer_jul06.py — renders the 5 STAGED soccer player pages into drafts/ready/ (gitignored).
Same shell-slice approach as build_jul06.py; promote later with promote_ready.py.
"""
import os
import page_builder as pb
import content_soccer_jul06 as content
...
if __name__ == "__main__":
    ...
    print("== Building STAGED soccer pages (drafts/ready/, gitignored) ==")
