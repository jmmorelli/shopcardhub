#!/usr/bin/env python3
"""
build_aug17.py — one-shot builder for the Aug 17, 2026 weekly-scan pages:
...
import content_aug17 as content
...
NEW_SITEMAP_URLS = [
    ("topps-chrome-sapphire-2026", 0.8),
    ("topps-pristine-basketball", 0.8),
]
...
if __name__ == "__main__":
    print("== Building Aug 17 release pages ==")
