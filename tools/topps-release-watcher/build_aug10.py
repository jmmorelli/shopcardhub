#!/usr/bin/env python3
"""
build_aug10.py — one-shot builder for the Aug 10, 2026 weekly-scan pages:
...
import content_aug10 as content
...
NEW_SITEMAP_URLS = [
    ("topps-museum-collection-baseball", 0.8),
    ("topps-definitive-basketball", 0.8),
]
