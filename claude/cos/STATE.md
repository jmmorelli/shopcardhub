...
| **TAG affiliate program exists** (UpPromote, partner.taggrading.com/tag/register; $1/item flat, page meta also cites 10% of referral sales; 30-day cookie; needs a W-9). **Needs Mo** (NEEDS-MO). COMC raised per-item shipping in March 2026 (graded $1→$2). | **Mo** |
